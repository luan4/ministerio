...
if __name__ == "__main__":
    ...
    perceptron_MNIST.train(train_sample_list[:1000], train_sample_list[1000:2000], max_epochs=105, learning_rate=0.5, mezclar=True)
    print()
    print()
    misteaks = 0
    ...
    with open("./lector_digits.pkl", "bw") as fh:
        pickle.dump(perceptron_MNIST, fh)
